...
<%@ page import="in.gadgethub.dao.impl.*,in.gadgethub.pojo.*,in.gadget.dao.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*" %> 
...
<html> 
    ...
    <body style="background-color: #E6F9E6;"> 
        ...
        <% 
            ...
            if (product == null) { 
                out.print("<h2 style='color:red;'>Product not found!</h2>"); 
                return; 
            }
        %> 
