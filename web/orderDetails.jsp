...
<%@ page import="in.gadgethub.dao.impl.*,in.gadget.dao.*,in.gadgethub.pojo.*,javax.servlet.ServletOutputStream,java.io.*,java.util.*" %>
...
<body style="background-color: #E6F9E6;">
    ...
    %>
    <a href="orderDetails.jsp"></a>

    <jsp:include page="header.jsp" />

    <div class="text-center text-primary h3 m-3"></div>
